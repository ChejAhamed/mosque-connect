    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[600px]">
        <DialogHeader>
          ...
          <DialogDescription>
            {isEditing
              ? 'Update the details of your announcement below. All fields marked with * are required.'
              : 'Fill out the form below to create a new announcement. All fields marked with * are required.'}
          </DialogDescription>
        </DialogHeader>
