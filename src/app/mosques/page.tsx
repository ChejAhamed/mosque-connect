...
const DUMMY_MOSQUES = [
  {
    ...
    zipCode: "E1 1JQ",
    facilityFeatures: ["Prayer Hall", "Library", "Classes", "Events"],
    verified: true,
  },
  {
    _id: "2",
    ...
    state: "West Midlands",
    zipCode: "B12 0XS",
    facilityFeatures: ["Prayer Hall", "Community Center", "Parking"],
    verified: true,
  },
  {
    _id: "3",
    ...
    zipCode: "M14 5RU",
    facilityFeatures: ["Prayer Hall", "Gardens", "Meeting Rooms"],
    verified: true,
  }
];
