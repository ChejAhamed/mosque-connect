...
import {
  User, Users, Mosque, Store, MapPin, ChevronUp, Activity,
  Male, Female, BarChart, PieChart
} from 'lucide-react';
        ...
        <TabsContent value="overview" className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <StatCard
              ...
              icon={<Mosque className="h-8 w-8 text-green-600" />}
              trend={5}
            />
            <StatCard
              title="Businesses"
                  ...
                  <div className="w-full max-w-md">
                    <div className="flex flex-col space-y-4">
                      <GenderBar
                        ...
                        color="bg-blue-500"
                        icon={<Male className="h-4 w-4 mr-2" />}
                      />
                      <GenderBar
                        label="Female"
                        ...
                        total={stats.users.total}
                        color="bg-pink-500"
                        icon={<Female className="h-4 w-4 mr-2" />}
                      />
                      <GenderBar
