...
const formSchema = z.object({
  ...
  role: z.enum(["user", "imam", "business"]),
  city: z.string().min(2, {
...
function RegisterForm() {
  ...
  const roleDescriptions = {
    user: "Register as a community member to connect with local mosques and businesses.",
    imam: "Register as an imam to manage your mosque, events, and connect with volunteers.",
                    ...
                    <FormDescription>
                      ...
                      {field.value === "user" && (
                        <span className="block mt-1 text-green-600">
                          * As a community member, you can volunteer for mosque activities after registration.
                        </span>
                      )}
                    </FormDescription>
                    <FormMessage />
